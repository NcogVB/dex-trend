...
const RemoveLiquidity: React.FC = () => {
    ...
    const fetchPositionData = useCallback(async () => {
        ...
        try {
            ...
            let pos;
            try {
                // Ensure tokenId is a valid BigInt string
            ...
            // Access by index as fallback (safety for different Ethers versions/RPCs)
            // Struct: nonce(0), operator(1), token0(2), token1(3), fee(4), tickLower(5), tickUpper(6), liquidity(7)
            ...
            // 🛑 CRITICAL CHECK: Ensure we have addresses
            if (!token0Addr || !token1Addr) {
                throw new Error("Failed to fetch token addresses from position.");
            }
            ...
            // 4. Get Pool State & Token Data
            // 🛑 Guard: Ensure poolAddress is not null when creating Contract
            const poolContract = new ethers.Contract(poolAddress, UNISWAP_V3_POOL_ABI, provider);
            
            // 🛑 Guard: Ensure token addresses are valid
            ...
            // Estimate Fees (Rough approximation based on Owed fields)
    ...
    // Debounce fetching when typing ID
    useEffect(() => {
    ...
    const handleRemove = async () => {
        ...
        try {
            ...
            await fetchPositionData(); // Refresh data
    ...
    // Calculate Estimated Returns based on Slider
            ...
            <div className="w-full max-w-[600px]">
                <div className="bg-white shadow-xl border border-gray-100 rounded-[32px] overflow-hidden">
                    ...
                    <div className="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-100 focus:border-blue-500 outline-none transition-all font-mono text-lg"
                                />
                        ...
                        {/* 2. Main Content (Only show if data loaded) */}
                        {liquidityData && (
                            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    ...
                                    <div className="flex justify-between items-center mb-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <span className="text-xs bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded font-medium">{(liquidityData.fee / 10000).toFixed(2)}% Fee</span>
                                            </div>
                                        </div>
                                ...
                                <div className="bg-gray-50 rounded-2xl p-5 border border-gray-200 space-y-4">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="text-right">
                                            ...
                                            {liquidityData.unclaimedFees0 > 0 && (
                                                <span className="text-xs text-green-600 font-medium">+ {liquidityData.unclaimedFees0.toFixed(6)} Fees</span>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="text-right">
                                            ...
                                            {liquidityData.unclaimedFees1 > 0 && (
                                                <span className="text-xs text-green-600 font-medium">+ {liquidityData.unclaimedFees1.toFixed(6)} Fees</span>
                                            )}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button
                                    ...
                                    disabled={isRemoving || percentage === 0 || !account}
                                    className={`w-full mt-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center gap-2
                        ...
                        {/* Empty State / Prompt */}
                        {!liquidityData && !isFetching && !error && (
                            <div className="text-center py-10 opacity-50">
                                <Wallet className="w-12 h-12 mx-auto mb-3 text-gray-400" />
                                <p className="text-gray-500">Enter a Position ID to load details.</p>
                            </div>
                        )}
                    </div>
                </div>
