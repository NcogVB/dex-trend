const EarnPassiveIncomeSection = () => (
    <section className="md:py-[56px] py-[25px] px-4 text-center">
        ...
        <a
            href="#"
            className="py-[13px] px-[35px] bg-[#DC2626] rounded-[80px] font-medium text-base leading-4 text-center text-white inline-block hover:bg-[#B91C1C] transition-colors"
        >
            Start your journey
        </a>
    </section>
